// Funciones para dibujar formas geométricas paramétricas.
...
.text
.globl draw_rectangle // Declara draw_rectangle como global.

// draw_rectangle(framebuffer_base (x0), x_start (x1), y_start (x2), width (x3), height (x4), color (w5))
